...
from serverless_aws_bastion.config import TASK_ROLE_NAME, TASK_EXECUTION_ROLE_NAME
...
def create_bastion_task_role() -> str:
    ...
    attach_policies_to_role(TASK_ROLE_NAME, [
...
def create_bastion_task_execution_role() -> str:
    ...
    attach_policies_to_role(TASK_EXECUTION_ROLE_NAME, [
